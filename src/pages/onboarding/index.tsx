...
function Index({ user, currentUser, currentNft }) {
	return (
		<Div hScreen bgWhite flex justifyCenter itemsCenter>
			<Div>
				<Div py50>
					<Div mxAuto maxW={650} textLg textCenter fontSemibold>
						<Div spanTag textPrimary textXl>
							BetterWorld αlpha
							<br />
						</Div>
						곰즈들에게 생명을 불어 넣어주어요
					...
					<EmptyBlock h={30} />
					<Div textCenter maxW={800} px30 mxAuto textBase>
