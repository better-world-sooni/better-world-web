...
import { MakeBrowserModal, MakeKaikasModal } from "src/components/modals/CheckModal";
...
function SorryNotHolder() {
	const gotodiscord = () => href(LINKS.discord)
	return (
	...
	return (
		...
		<Div hFull px80 flex itemsCenter justifyCenter bgBlack auto bgWhite>
			<Div maxW={1100} mb100 rounded1000 py50 px100 bgWhite bgOpacity90>
				...
				<Div flex justifyCenter mt30>
				{loginStatus ? 
				<Div textWhite bgBlack bgOpacity50 rounded100 fontSize24 py8 px32 flex flexRow gapX={10} itemsCenter fontBold>
					<Div mb2><Oval height="24" width="24" color="black" secondaryColor="#FFFFFF" strokeWidth="8" /></Div>
					<Div mr8>지갑 연결</Div>
				</Div>
				:
