...
export default function FooterDraft({time, once, appstore, playstore}) {
	...
	<Div flexCol selfCenter itemsCenter>
		<motion.li variants={text1Animation}><Div imgTag h70 src={IMAGES.logoword.firstBlack}/></motion.li>
		<motion.li variants={text2Animation}><Div mt30 imgTag h={26} src={IMAGES.logoword.secondGradient}/></motion.li>
	</Div>
	</Div>
