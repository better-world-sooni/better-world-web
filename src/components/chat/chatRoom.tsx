...
export default function ChatRoom({ currentRoomId, currentNftId, messages, numNfts, closeOnClick, sendOnClick }) {
	...
	return (
		<Div flex flexCol itemsStretch>
			<Row flex itemsCenter>
				<Col auto justifyCenter>
					<Div onClick={() => closeOnClick()}>
						<Image alt="back" src={IMAGES.backButton} height={25} width={25} />
					</Div>
				</Col>
				<Col auto justifyCenter>
			...
			<Row flex>
				<Messages messages={messages} currentNftId={currentNftId} numNfts={numNfts} />
			</Row>
