...
const propsToClx = (props) => {
  ...
  const map = {
    ...
    //font-size
    textXs: () => addStyle(styles, "", { fontSize: 10 }),
    ...
    text3xl: () => addStyle(styles, "", { fontSize: 32 }),
    // background-color
    ...
    noScrollBar: () => clxs.push("no-scrollbar"),
    // overscroll
  ...
  const withTipComp = React.forwardRef((props: DivPropsType, ref: any) => {
    ...
    return (
      <>
        ...
        {dataTip && <ReactTooltip id={dataFor} className="react-tooltip px-8 py-7 text-h6" effect="solid" place="right" backgroundColor={COLORS.SECONDARY} />}
      </>
    );
  });
